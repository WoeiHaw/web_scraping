            ...
            for i in range(5):
                try:
                    ...
                    for i in range(len(color_elements)):
                        ...
                        description_sku = description_sku.replace("Slip Ins", "Slip-Ins").replace(
                            "Men Go Consistent On The Go",
                            "Men On-The-GO GO Consistent").replace(
                            "Gowalk", "GOwalk").replace("Usa", "USA").replace("Bobs", "BOBS").replace(
                            "Go Pickleball",
                            ...
                            "On The Go Go", "On-The-GO GO").replace("Skech Air", "Skech-Air").replace("Skech Lite",
                                                                                                      "Skech-Lite").replace(
                            "Dlites", "D'Lites").replace("Dlux", "D'Lux").replace("On The Go", "On-The-GO").replace(
                            "Dc Comics", "DC Comics").replace("Tres Air", "Tres-Air")
